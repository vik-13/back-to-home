window.characterAnimations = (() => {
  const size = [36, 59];
  const gMain = [[[0,9,36,0,21,26],'','black',1],[[21,27,34,39,34,59],'','r',1],[[21,27,21,45,8,58],'','r',1],[[22,7,29,6,26,11],'','red',1]];
  const gList = {
    stay: [
      gMain,
    ...
    wall: [
      [[[0,2,34,0,20,21],'','black',1],[[20,20,40,30,34,14],'','r',1],[[19,20,32,33,38,53],'','r',1],[[12,9,7,4,14,4],'','red',1]],
      []
    ],
    fall: [
      [[[3,0,39,10,13,26],'','black',1],[[13,25,26,38,26,57],'','r',1],[[13,25,13,44,0,57],'','r',1],[[23,8,30,10,25,13],'','red',1]],
    ...
    flying: [
      [[[38,0,63,28,32,27],'','black',1],[[32,26,21,40,2,42],'','r',1],[[32,26,13,27,0,14],'','r',1],[[51,19,56,24,50,24],'','red',1]],
