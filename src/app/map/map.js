window.map = (() => {
  ...
  const levels = [
    ...
    [[8,14,0,3,1],[8,17,0,3,1],[8,20,0,3,1],[8,23,0,3,1],[8,26,0,3,1],[8,29,0,3,1],[8,32,0,3,1],[8,35,0,3,1],[8,38,0,3,1],[8,41,0,3,1],[0,44,0,16,6],[7,59,6,1,1],[6,0,6,1,1],[0,0,0,14,6]],
    // LAST!!!
    [[0,0,0,50,1],[6,0,1,1,1],[7,49,1,1,1]]
  ];
  let backward = false;
